 ...
 * than the box above it in width, height, and depth.
 *
 * <p>Implement a method to compute the height of the tallest possible stack. The height of a stack
 * is the sum of the heights of each box.
 */
class _08_13_StackOfBoxes {
